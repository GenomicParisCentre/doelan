...
/**
 * Wrapper of QualityGlobalTestResult.
 * @author Laurent Jourdren
 */
public class QualityGlobalTestResultData extends Data implements Module {
  ...
  public String getName() {
    return SystemUtils
        .getClassNameWithoutPackage(QualityGlobalTestResultData.class);
  }
  ...
  public String getType() {
    ...
    return DoelanDataDefaults.GLOBAL_TEST_RESULT_TYPE;
  }
  ...
  public Class getDataClass() {
    return QualityGlobalTestResult.class;
  }
   ...
   */
  public void setData(final QualityGlobalTestResult result) {
  ...
  public AboutModule aboutModule() {
    ...
    try {
      md = new ModuleDescription("QualityGlobalTestResult",
          "QualityUnitTest result data type");
    } catch (PlatformException e) {
   ...
   */
  public QualityGlobalTestResultData(final QualityGlobalTestResult result) {
    setData(result);
  }
